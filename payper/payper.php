...
<script type='text/javascript' src='https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js'></script>
	...
	<!-- END OF THE PLAYER --><? //echo $host; ?>
    <div id="mediaplayer">    
    <video id=home_video class="video-js vjs-default-skin" controls preload="auto" width=<?php echo ($width-50); ?> height=<?php echo ($height-110); ?>></video>
    </div>
...
<form action="<?php echo $paypal_link; ?>" target="_top" method="post" name="payPalForm">
                   ...
                   <?php /*?> <input type="text" name="custom" placeholder="email" value="" /><br><?php */?>
                    ...
                    <?php /*?><input type="hidden" name="image_url" value="<?php echo $image_url; ?>"> <?php */?>
