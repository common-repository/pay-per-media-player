...
$stable = $table_prefix.'payper_sales';


/*if( basename($_SERVER['REQUEST_URI']) == "payper.js.php" ) {

$uri = explode("payper.js.php", $_SERVER['REQUEST_URI']);
...
$siteurl = get_bloginfo('url')."/wp-content/plugins/pay-per-media-player/payper/";
